...
function Feed() {
  return (
    <div className="flex flex-col border-2 box-content h-auto max-w-screen-md p-2 px-4 bg-black text-white rounded-3xl ">
      <div className="m-4 p-2 justify-center space-x-10 flow-root">
        <div className="flex flex-row float-left box-content space-x-2">
          <div className="box-content p-2 py-3  bg-secondary rounded-2xl">
            profileName:
          </div>
          <div className="bg-stone-900 h-8 w-44 box-content p-2 content-center rounded-md">
            mohammad
          </div>
        </div>

        <div className="flex flex-row float-right box-content space-x-2">
          <div className="box-content p-1 bg-secondary rounded-2xl">
            <UserIcon className="size-10"></UserIcon>
          </div>
          <div className="bg-stone-900 h-8 w-44 box-content p-2 content-center rounded-md hover:text-cyan-700 hover:font-bold">
            <p>me76ss</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col box-content m-4 p-2 space-x-4 justify-between">
        <div className="flex space-x-2  m-3">
          ...
          <div className="bg-stone-900 h-10 w-44 box-content p-2 rounded-2xl content-center">
            rbwrwfefrb
          </div>
          <div className="content-center  bg-secondary rounded-2xl p-2 h-14 w-44">
            likes:
